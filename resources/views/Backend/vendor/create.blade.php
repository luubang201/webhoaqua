                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Thêm thông nhà cung cấp</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email" placeholder="Nhập email nhà cung cấp">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="website" placeholder="nhập website" name="website">
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <textarea name="address" class="form-control" rows="3" placeholder="Nhập địa chỉ" ></textarea>
                                    </div>
{{--                                    <div class="form-group">--}}
